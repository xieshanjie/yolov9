...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, MPDIoU=False, Inner=False, FocalerIoU=False, ratio=0.7, feat_h=960, 
             feat_w=960, eps=1e-7, d=0.00, u=0.95):
